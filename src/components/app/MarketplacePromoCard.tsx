...
export function MarketplacePromoCard({ marketplaceHref }: { marketplaceHref: string }) {
  return (
    <section className="group relative overflow-hidden rounded-2xl bg-[#e9e1ff] p-2 shadow-[0_8px_24px_rgba(90,78,224,0.15)]">
      <div className="relative overflow-hidden rounded-xl border border-[#d5cafa] bg-[linear-gradient(55deg,rgba(92,72,215,0.08)_25%,transparent_25%,transparent_50%,rgba(92,72,215,0.08)_50%,rgba(92,72,215,0.08)_75%,transparent_75%)] bg-size-[36px_36px] px-2 py-3">
